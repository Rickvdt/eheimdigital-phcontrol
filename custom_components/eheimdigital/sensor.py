...
from eheimdigital.types import FilterErrorCode, PHControlErrorCode
...
PHCONTROL_DESCRIPTIONS: tuple[
    ...
    EheimDigitalSensorDescription[EheimDigitalPHControl](
        key="carbonate_hardness",
        translation_key="carbonate_hardness",
...
async def async_setup_entry(
    ...
    """Set up callbacks for the coordinator to add sensors as devices are found."""
